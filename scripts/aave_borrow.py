...
def main():
    ...
    # Aprove sending out ERC20 tokens
...
def get_borrowable_data(lending_pool, account):
    ...
    print(f"You have {available_borrow_eth} worth of ETH/Max amount you can borrow.  The maximum amount that you can borrow will always be less than your collateral")
    return (float(available_borrow_eth),float(total_debt_eth))
    #0.00000001 deposited
    #0.00000000825 can be borrowed
